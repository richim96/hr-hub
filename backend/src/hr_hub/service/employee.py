...
from hr_hub.model.dto import EmployeeDTO, ResponseDTO
...
def start_onboarding(request: Request, event: NewHireRequest) -> ResponseDTO:
...
def _create_it_tasks(employee: EmployeeDTO) -> list[Action]:
